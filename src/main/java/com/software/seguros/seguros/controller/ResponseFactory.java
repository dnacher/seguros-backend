...
public class ResponseFactory {
    ...
    public ResponseEntity<?> createResponseEntity(Map<String, Object> body, String errormessage, HttpStatus httpStatus) {
        body.put("status", httpStatus.value());
        body.put("error", errormessage);
        return new ResponseEntity<>(body, httpStatus);
    }

    public ResponseEntity<?> handleErrorCodes(Map<String, Object> body, final Codigo error, SegurosException ex) {
